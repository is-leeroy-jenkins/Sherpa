...
SELECT DISTINCTROW PayrollObligations.RPIO AS RPIO, PayrollObligations.AhCode AS AhCode, PayrollObligations.BFY AS BFY, PayrollObligations.RcCode AS RcCode, PayrollObligations.DivisionName AS DivisionName, PayrollHours.EpaNumber AS EpaNumber, PayrollHours.LastName AS LastName, PayrollHours.FirstName AS FirstName, PayrollObligations.FundCode AS FundCode, PayrollObligations.FundName AS FundName, PayrollObligations.OrgCOde AS OrgCOde, PayrollObligations.AccountCode AS AccountCode, PayrollObligations.ProgramProjectCode AS ProgramProjectCode, PayrollObligations.ProgramProjectName AS ProgramProjectName, PayrollObligations.WorkCode AS WorkCode, PayrollObligations.HrOrgCode AS HrOrgCode, PayrollObligations.PayPeriod AS PayPeriod, PayrollHours.StartDate AS StartDate, PayrollHours.EndDate AS EndDate, 
