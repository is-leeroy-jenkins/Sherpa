...
SELECT PayrollObligations.BFY,
	   PayrollObligations.AhCode                     AS [AH Code],
	   PayrollObligations.FundCode                   AS [Fund Code],
	   ...
	   PayrollObligations.FocCode                    AS FocCode,
	   PayrollObligations.FocName                    AS FocName,
	   PayrollObligations.WorkCode                   AS WorkCode,
	   PayrollObligations.WorkCodeName               AS WorkCodeName,
	   PayrollHours.EmployeeNumber                   AS EmployeeNumber,
	   PayrollHours.LastName                         AS LastName,
	   PayrollHours.FirstName                        AS FirstName,
	   PayrollHours.HumanResourceOrganizationCode    AS HrOrgCode, \
	   PayrollHours.HumanResourceOrganizationName    AS HrOrgName,
