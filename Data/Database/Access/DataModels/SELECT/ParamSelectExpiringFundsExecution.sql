...
SELECT Purchases.RpioCode                AS RPIO,
	   Purchases.AhCode,
	   Purchases.BFY,
	   Purchases.FundCode,
	   Purchases.FundName,
	   Purchases.DocumentControlNumbers  AS DCN,
	   Purchases.PurchaseRequestNumber   AS PurchaseRequest,
	   Purchases.OrgCode,
	   Purchases.AccountCode,
	   Purchases.ActivityCode,
	   ...
	   Purchases.LastActionDate,
	   CCur( Purchases.OpenCommitments ) AS OpenCommitments,
	   CCur( Purchases.ULO )             AS ULO,
...
GROUP BY Purchases.RpioCode, Purchases.AhCode, Purchases.BFY, Purchases.RcCode, Purchases.FundCode,
		 Purchases.FundName, Purchases.DocumentControlNumbers, Purchases.PurchaseRequestNumber,
		 Purchases.OrgCode, Purchases.AccountCode, Purchases.ActivityCode,
		 Purchases.ProgramProjectName, Purchases.BocCode, Purchases.BocName, Purchases.FocCode,
		 Purchases.FocName, Purchases.OriginalActionDate, Purchases.LastActionDate,
		 Purchases.OpenCommitments, Purchases.ULO, Allocations.Amount, Allocations.DivisionName,
		 Allocations.DivisionName
