SELECT DISTINCTROW Allocations.PrcId, Allocations.BFY, Allocations.BudgetLevel, Allocations.AhCode, 
Allocations.FundName, Allocations.FundCode, Allocations.OrgCode, Allocations.AccountCode, Allocations.BocCode, Allocations.BocName, Allocations.DivisionName, Allocations.RcCode, Allocations.ProgramProjectName, 
