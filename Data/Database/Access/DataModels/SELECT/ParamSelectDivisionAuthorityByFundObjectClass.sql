...
SELECT DISTINCTROW DivisionAuthority.RPIO , DivisionAuthority.BFY,
...
GROUP BY DivisionAuthority.RPIO, DivisionAuthority.BFY, DivisionAuthority.AhCode,
		 DivisionAuthority.FundCode, DivisionAuthority.RcCode, DivisionAuthority.DivisionName,
		 DivisionAuthority.FundName, DivisionAuthority.OrgCode, DivisionAuthority.AccountCode,
