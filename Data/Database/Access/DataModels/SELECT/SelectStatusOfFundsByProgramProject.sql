...
GROUP BY StatusOfFunds.BFY, StatusOfFunds.RpioName, StatusOfFunds.RpioCode, StatusOfFunds.FundCode,
		 StatusOfFunds.FundName, StatusOfFunds.ProgramProjectCode, StatusOfFunds.ProgramProjectName;