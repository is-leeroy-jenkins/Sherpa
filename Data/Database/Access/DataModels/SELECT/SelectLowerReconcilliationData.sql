SELECT DISTINCTROW Allocation.PrcId, Allocations.BFY, Allocations.BudgetLevel, Allocations.AhCode, Allocations.FundName, Allocations.FundCode, Allocations.OrgCode, Allocations.AccountCode, Allocations.BocCode, Allocations.BocName, Allocations.ProgramProjectName, Allocations.RcCode, Allocations.DivisionName, 
...
GROUP BY Allocations.PrcId, Allocations.BFY, Allocations.BudgetLevel, Allocations.AhCode, Allocations.FundName, Allocations.FundCode, Allocations.OrgCode, Allocations.AccountCode, Allocations.BocCode, Allocations.BocName, Allocations.ProgramProjectName, Allocations.RcCode, Allocations.DivisionName, CCur((Round(Allocations.Amount,2))), CCur((Round(ExternalUpdates.Amount,2))), CCur((0-Round(Nz([Allocations].[Amount],2)-Round(ExternalUpdates.Amount,2),2))), 
IIf((0-Round(Nz([Allocations].[Amount],2)-Round(ExternalUpdates.Amount,2),2))<0, "DECREASE", 
IIf((0-Round(Nz([Allocations].[Amount],2)-Round(ExternalUpdates.Amount,2),2))>0, "INCREASE",
"NET ZERO"))
