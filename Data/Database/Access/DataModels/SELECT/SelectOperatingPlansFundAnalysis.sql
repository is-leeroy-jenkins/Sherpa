SELECT DISTINCT StatusOfFunds.BFY                                                       AS BFY,
				...
				IIf( SUM( StatusOfFunds.Amount ) - SUM( OperatingPlans.Amount ) < 0, "DECREASE",
					 "INCREASE" )                                                       AS NET,
...
GROUP BY StatusOfFunds.BFY, StatusOfFunds.RpioCode, StatusOfFunds.RpioName, StatusOfFunds.FundCode,
		 StatusOfFunds.FundName, StatusOfFunds.ProgramAreaCode, StatusOfFunds.AccountCode,
		 StatusOfFunds.ProgramProjectCode, StatusOfFunds.ProgramProjectName, StatusOfFunds.BocCode,
		 StatusOfFunds.BocName,
		 CCur( Round( Abs( StatusOfFunds.Amount - OperatingPlans.Amount ), 2 ) )
ORDER BY StatusOfFunds.RpioCode, StatusOfFunds.RpioName, StatusOfFunds.FundCode,
		 StatusOfFunds.AccountCode, StatusOfFunds.BocCode, StatusOfFunds.BFY DESC;