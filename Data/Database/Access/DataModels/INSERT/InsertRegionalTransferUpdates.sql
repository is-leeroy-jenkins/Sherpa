...
SELECT Transfers.BFY                       AS BFY,
	   ...
	   Nz( Switch( [FundCode] ALike 'E4%' And [NpmCode]='B', '06K',
        ...
        ('10','21','38') Or [AhCode] ALike '6A%' And [BocCode] Not In ('10','21','38'), '06L',
				   Len( [AccountCode] ) = 6 And [NpmCode] = 'B' And
...
GROUP BY Transfers.ReprogrammingNumber, Transfers.ProcessedDate, Transfers.BFY, Transfers.RpioCode,
        ...
        ('10','21','38') Or [AhCode] ALike '6A%' And [BocCode] Not In ('10','21','38'), '06L',
					 ...
					 [NpmCode] = 'Y' Or [AccountCode] ALike '%02' Or [AccountCode] ALike '%03',
					 '06N' ), '06' ),
		 Transfers.DocPrefix, IIf( [DocPrefix] <> 'CRP', Left( [ControlNumber], 2 ), '17' ),
		 Transfers.BudgetLevel, Transfers.DocPrefix, Transfers.DocType, Transfers.NpmCode,
		 Transfers.Purpose, Transfers.ExtendedPurpose, Transfers.ResourceType
