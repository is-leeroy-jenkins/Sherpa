...
SELECT DISTINCT StatusOfFunds.BudgetLevel                    AS BudgetLevel,
...
ORDER BY StatusOfFunds.BFY, StatusOfFunds.FundCode, StatusOfFunds.AccountCode,
