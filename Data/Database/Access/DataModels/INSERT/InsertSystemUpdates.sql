...
SELECT DISTINCT StatusOfFunds.StatusOfFundsId                   AS ExtId,
				'06'                                            AS RPIO,
				StatusOfFunds.BudgetLevel                       AS BudgetLevel,
				...
				StatusOfFunds.ProgramProjectCode                AS ProgramProjectCode,
				StatusOfFunds.ProgramProjectName                AS ProgramProjectName,
				StatusOfFunds.ProgramAreaCode                   AS ProgramAreaCode,
				StatusOfFunds.ProgramAreaName                   AS ProgramAreaName,
				StatusOfFunds.BocCode                           AS BocCode,
				StatusOfFunds.BocName                           AS BocName,
				StatusOfFunds.RcCode                            AS RcCode,
				StatusOfFunds.Amount                            AS Amount,
				StatusOfFunds.NpmCode                           AS NpmCode,
				StatusOfFunds.NpmTitle                          AS NpmName,
