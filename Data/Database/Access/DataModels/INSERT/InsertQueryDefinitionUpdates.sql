...
SELECT Transfers.BFY                       AS BFY,
	   ...
	   Nz( Switch( [FundCode] ALike E4% And [NpmCode]=B, 06 K, [BocCode] = 38, 06 G,
				   [FundCode] ALike T% And [NpmCode]<>Y And Len([AccountCode])=6  OR [AccountCode] LIKE %DC3 AND [BocCode]<>38 Or [AhCode] ALike 6A% And [BocCode]<>38,
				   06 L,
				   [AccountCode] ALike %M20 Or Len([AccountCode])=6 And [NpmCode]=B And [BocCode] Not In (10,38),
				   06 K, [NpmCode] = A Or [FundCode] ALike E#% And [NpmCode]=A, 06 J,
				   [FundCode] ALike E1% And [NpmCode] In (C,D,E), 06 B,
				   [FundCode] = B And Len( [AccountCode] ) = 6 And [NpmCode] = E, 06 M,
				   [FundCode] ALike E4% And [NpmCode]=D, 06 B, [FundCode] ALike B% And [NpmCode]=B,
				   06 K, [NpmCode] = L Or
						 [AccountCode] ALike %57 Or [AccountCode] ALike %M90 And [BocCode]<>10,
				   06 F,
				   [AccountCode] ALike %XW2 Or [AccountCode] ALike %RL Or [NpmCode]=F And [BocCode]<>10,
				   06 H, [FundCode] ALike F%, 06 B,
				   [FundCode] = B And [NpmCode] In ( C, D ) And [BocCode] <> 10, 06 B,
				   [NpmCode] = Y Or
				   [AccountCode] ALike %02 Or [AccountCode] ALike %03 And [BocCode] Not In (10,38),
				   06 N ), 06 )            AS RcCode,
