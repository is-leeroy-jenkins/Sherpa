...
SELECT Transfers.BFY                       AS BFY,
	   ...
	   Nz( Switch( [FundCode] ALike "E4%" And [NpmCode]='B', "06K", [BocCode] = "38", "06G",
				   ...
				   '06L', Len( [AccountCode] ) = 6 And [NpmCode] = 'B' And
						  [BocCode] Not In ( '10', '21', '38' ), '06K',
