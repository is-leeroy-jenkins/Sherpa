...
SELECT StatusOfFunds.BFY,
	   ...
	   Sum( StatusOfFunds.OpenCommitments )                    AS [Open Commitments],
	   Sum( StatusOfFunds.Obligations )                        AS Obligations,
	   Sum( StatusOfFunds.Used )                               AS Used,
	   Sum( StatusOfFunds.Amount ) - Sum( StatusOfFunds.Used ) As Available
FROM StatusOfFunds
...
GROUP BY StatusOfFunds.BFY, StatusOfFunds.RpioCode, StatusOfFunds.RpioName,
		 StatusOfFunds.ProgramProjectName, StatusOfFunds.AccountCode,
		 Sum( StatusOfFunds.Amount ) - Sum( StatusOfFunds.Used )
