CREATE TABLE DeobligationAcitvity 
(
    DeobligationAcitvityId AUTOINCREMENT NOT NULL UNIQUE,
    ...
    CONSTRAINT DeobligationActivityPrimaryKey
        PRIMARY KEY(DeobligationAcitvityId)
);