...
(
	 StatusOfInflationReductionActFundsId AUTOINCREMENT NOT NULL UNIQUE,
     ...
     CONSTRAINT StatusOfInflationReductionActFundsPrimaryKey
	    PRIMARY KEY(StatusOfInflationReductionActFundsId)
);