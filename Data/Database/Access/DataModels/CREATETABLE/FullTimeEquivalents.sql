...
(
    FullTimeEquivalentsId AUTOINCREMENT NOT NULL UNIQUE,
    ...
    CONSTRAINT FullTimeEquivalentsPrimaryKey 
      PRIMARY KEY(FullTimeEquivalentsId),
    CONSTRAINT OperatingPlansForeignKey 
      FOREIGN KEY(OperatingPlansId) REFERENCES OperatingPlans(OperatingPlansId)
);