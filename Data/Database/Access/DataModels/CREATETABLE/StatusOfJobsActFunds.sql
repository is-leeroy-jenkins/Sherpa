CREATE TABLE  StatusOfJobsActFunds  
(
    StatusOfJobsActFundsId AUTOINCREMENT NOT NULL UNIQUE,
    ...
    CONSTRAINT StatusOfJobsActFundsPrimaryKey 
      PRIMARY KEY(StatusOfJobsActFundsId)
);