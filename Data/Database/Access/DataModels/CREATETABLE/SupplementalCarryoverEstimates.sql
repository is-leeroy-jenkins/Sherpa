...
(
    SupplementalCarryoverEstimatesId AUTOINCREMENT NOT NULL UNIQUE,
    ...
    CONSTRAINT SupplementalCarryoverEstimatesPrimaryKey
        PRIMARY KEY(SupplementalCarryoverEstimatesId)
);