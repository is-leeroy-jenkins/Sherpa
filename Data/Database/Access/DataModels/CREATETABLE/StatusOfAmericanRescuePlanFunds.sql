...
(
	 StatusOfAmericanRescuePlanFunds Id AUTOINCREMENT NOT NULL UNIQUE,
     ...
     CONSTRAINT StatusOfAmericanRescuePlanFunds PrimaryKey
	    PRIMARY KEY(StatusOfAmericanRescuePlanFunds Id)
);