...
(
	RegionalAuthorityId INTEGER NOT NULL UNIQUE CONSTRAINT PrimaryKeyRegionalAuthority PRIMARY KEY,
	...
	CONSTRAINT ForeignKeyRegionalAuthorityRescissions
	FOREIGN KEY (RescissionId)
	REFERENCES Rescission,
	CONSTRAINT ForeignKeyRegionalAuthorityAllocations
	FOREIGN KEY (PrcId)
