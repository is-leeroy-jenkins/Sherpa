...
SELECT DISTINCTROW StatusOfFunds.BFY AS BFY, StatusOfFunds.EFY AS EFY, StatusOfFunds.FundCode AS FundCode, StatusOfFunds.FundName AS FundName, StatusOfFunds.RpioCode AS RpioCode, StatusOfFunds.RpioName AS RpioName, StatusOfFunds.AhCode AS AhCode, StatusOfFunds.AhName AS AhName, StatusOfFunds.OrgCode AS OrgCode, StatusOfFunds.OrgName AS OrgName, StatusOfFunds.AccountCode AS AccountCode, StatusOfFunds.ProgramProjectName AS ProgramProjectName, StatusOfFunds.BocCode AS BocCode, StatusOfFunds.BocName AS BocName, 
