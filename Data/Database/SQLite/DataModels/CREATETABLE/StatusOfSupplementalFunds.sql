CREATE TABLE IF NOT EXISTS StatusOfSupplementalFunds 
(
	StatusOfSupplementalFundsId	INTEGER NOT NULL UNIQUE,
	...
	PRIMARY KEY(StatusOfSupplementalFundsId AUTOINCREMENT)
);