CREATE TABLE IF NOT EXISTS InflationReductionActCarryoverEstimates 
(
	InflationReductionActCarryoverEstimatesId INTEGER NOT NULL,
	...
	PRIMARY KEY(InflationReductionActCarryoverEstimatesId AUTOINCREMENT)
);