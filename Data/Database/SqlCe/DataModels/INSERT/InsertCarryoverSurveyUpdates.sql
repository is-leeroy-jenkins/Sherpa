...
SELECT Transfers.BFY                                          AS BFY,
       ...
       Nz( Switch(
               ...
               [BocCode] <> "10" AND [AhCode] ALike '6A%' OR [BocCode] <> "10" AND [FundCode] ALike 'T%' AND [NpmCode]<>'F' AND [NpmCode] <> 'Y',
                              '06L',
               [BocCode] <> "10" AND [FundCode] ALike 'E%' OR [BocCode] <> "10" AND [FundCode]='B' And [NpmCode]='A',
                              '06J',
               [BocCode] <> "10" AND [FundCode]='B' And [NpmCode]='E','06M',
               [BocCode] <> "10" AND [NpmCode]='L', '06F',
               [BocCode] <> "10" AND [AccountCode] ALike '%57' Or [BocCode] <> "10" AND [AccountCode] ALike "%M90",
                              '06F',
               [BocCode] <> "10" AND [NpmCode]='F' OR [BocCode] <> "10" AND [AccountCode] ALike '%XW2' OR [BocCode] <> "10" AND [AccountCode] ALike "%RL",
                              '06H',
               [BocCode] <> "10" AND [NpmCode]='Y' OR [BocCode] <> "10" AND [AccountCode] ALike '%02' OR [BocCode] <> "10" AND [AccountCode] ALike '%04' OR [BocCode] <> "10" AND [AccountCode] ALike '%03',
                              '06N' ), '06' )                 AS RcCode,
...
GROUP BY Transfers.ReprogrammingNumber, Transfers.ProcessedDate,
         IIf( [DocPrefix]<>'CRP',Left([ControlNumber],2),'17' ), Transfers.BFY, Transfers.RpioCode,
