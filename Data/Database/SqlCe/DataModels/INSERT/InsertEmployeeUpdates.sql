		PARAMETERS
		BudgetLevelArgs Text ( 255 ), RpioCodeArgs Text ( 255 ), AhCodeArgs Text ( 255 ), FiscalYearArgs Text ( 255 ), FundCodeArgs Text ( 255 ), OrgCodeArgs Text ( 255 ), AccountCodeArgs Text ( 255 ), BocCodeArgs Text ( 255 ), RcCodeArgs Text ( 255 ), AmountArgs IEEEDouble;
		INSERT INTO Allocations (RPIO, BudgetLevel, AhCode, BFY, FundCode, OrgCode, AccountCode,
								 ...
								 NpmCode, ProgramProjectCode, ProgramAreaCode, GoalCode,
								 ObjectiveCode,
								 DivisionName, NpmName, ProgramProjectName, ProgramAreaName,
								 GoalName,
		...
		SELECT Allocations.RPIO,
			   ...
			   Nz( DLookUp( "Name", "ProgramProjects",
							"ProgramProjects.Code=Mid([AccountCodeArgs],5,2)" ),
		...
		WHERE (((Allocations.RPIO) = "06")
			...
			AND ((Allocations.AccountCode) = [AccountCodeArgs])
