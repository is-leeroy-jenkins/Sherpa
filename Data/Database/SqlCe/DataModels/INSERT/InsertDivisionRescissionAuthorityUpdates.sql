INSERT INTO DivisionExecution (BudgetLevel, RPIO, BFY, AhCode, FundCode, RcCode, DivisionName,
							   ...
							   ProgramProjectName, BocCode, BocName, Amount, OpenCommitments,
							   Obligations, Used)
SELECT DISTINCTROW DivisionAuthority.BudgetLevel, DivisionAuthority.RPIO,
	   DivisionAuthority.BFY,
	   DivisionAuthority.AhCode,
	   DivisionAuthority.FundCode,
	   DivisionAuthority.RcCode,
	   DivisionAuthority.DivisionName,
	   DivisionAuthority.FundName,
	   DivisionAuthority.OrgCode,
	   DivisionAuthority.AccountCode,
	   DivisionAuthority.ActivityCode,
	   DivisionAuthority.ProgramProjectCode,
	   DivisionAuthority.ProgramProjectName,
	   DivisionAuthority.BocCode,
...
FROM DivisionAuthority
		 LEFT JOIN Purchases ON (DivisionAuthority.BFY = Purchases.BFY) AND
...
GROUP BY DivisionAuthority.BudgetLevel, DivisionAuthority.RPIO, DivisionAuthority.BFY,
		 DivisionAuthority.AhCode, DivisionAuthority.FundCode, DivisionAuthority.RcCode,
		 DivisionAuthority.DivisionName, DivisionAuthority.FundName, DivisionAuthority.OrgCode,
		 DivisionAuthority.AccountCode, DivisionAuthority.ActivityCode,
		 DivisionAuthority.ProgramProjectCode, DivisionAuthority.ProgramProjectName,
		 DivisionAuthority.BocCode, DivisionAuthority.BocName, DivisionAuthority.Amount
HAVING DivisionAuthority.Amount <> 0
ORDER BY DivisionAuthority.BFY DESC, DivisionAuthority.FundCode, DivisionAuthority.AccountCode,
		 DivisionAuthority.BocCode;