...
SELECT Transfers.BFY                      AS BFY,
       ...
       Nz(
               Switch( [FundCode] ALike "E4%" And [NpmCode]='B',"06K", [BocCode]="38","06G", [FundCode] ALike "T%" And Len([AccountCode])=6 OR [AccountCode] LIKE "%DC3" And [NpmCode]<>'Y' AND [BocCode] Not In ('10','21','38') Or [AhCode] ALike "6A%" And [BocCode] Not In ('10','21','38'),'06L',
                                                                Len( [AccountCode]) =
                                                                6 And [NpmCode]='B' And [BocCode] Not In ('10','21','38'),
                                                                '06K', [NpmCode]='A' Or [FundCode] ALike "E#%" And [NpmCode]='A','06J', [FundCode] ALike "E1%" And [NpmCode] In ('C','D','E'),'06B', [FundCode]='B' And Len([AccountCode])=6 And [NpmCode]='E','06M', [FundCode] ALike "E4%" And [NpmCode]='D','06B', [FundCode] ALike "B%" And [NpmCode]='B','06K', [NpmCode]='L' Or [AccountCode] ALike "%57" Or [AccountCode] ALike "%M90" And [BocCode] Not In ('10','21'),'06F', [AccountCode] ALike "%XW2" Or [AccountCode] ALike "%RL" Or [NpmCode]='F' And [BocCode] Not In ('10','21'),'06H', [FundCode] ALike "F%","06B", [FundCode]='B' And [NpmCode] In ('C','D') And [BocCode]<>"10","06B", [NpmCode]='Y' Or [AccountCode] ALike "%02" Or [AccountCode] ALike "%03","06N" ),
               '06' )                     AS RcCode,
       '06'                               AS SPIO,
...
GROUP BY Transfers.ReprogrammingNumber, Transfers.ProcessedDate, Transfers.BFY, Transfers.RpioCode,
         ...
         Nz(
                 Switch( [FundCode] ALike "E4%" And [NpmCode]='B',"06K", [BocCode]="38","06G", [FundCode] ALike "T%" And Len([AccountCode])=6  OR [AccountCode] LIKE "%DC3" And [NpmCode]<>'Y' AND [BocCode] Not In ('10','21','38') Or [AhCode] ALike "6A%" And [BocCode] Not In ('10','21','38'),'06L',
                                                                  ...
                                                                  6 And [NpmCode]='B' And [BocCode] Not In ('10','21','38'),
                                                                  '06K', [NpmCode]='A' Or [FundCode] ALike "E#%" And [NpmCode]='A','06J', [FundCode] ALike "E1%" And [NpmCode] In ('C','D','E'),'06B', [FundCode]='B' And Len([AccountCode])=6 And [NpmCode]='E','06M', [FundCode] ALike "E4%" And [NpmCode]='D','06B', [FundCode] ALike "B%" And [NpmCode]='B','06K', [NpmCode]='L' Or [AccountCode] ALike "%57" Or [AccountCode] ALike "%M90" And [BocCode] Not In ('10','21'),'06F', [AccountCode] ALike "%XW2" Or [AccountCode] ALike "%RL" Or [NpmCode]='F' And [BocCode] Not In ('10','21'),'06H', [FundCode] ALike "F%","06B", [FundCode]='B' And [NpmCode] In ('C','D') And [BocCode]<>"10","06B", [NpmCode]='Y' Or [AccountCode] ALike "%02" Or [AccountCode] ALike "%03","06N" ),
                 '06' ), Transfers.DocPrefix,
         IIf( [DocPrefix]<>'CRP',Left([ControlNumber],2),'17' ), Transfers.BudgetLevel,
...
HAVING ((IIf( [DocPrefix]<>'CRP',Left([ControlNumber],2),'17' )) = '06')
   AND ((Transfers.DocPrefix) = 'RP')
