...
namespace BudgetExecution
{
    ...
    public class BudgetCalendar : CalendarBase
    {
        ...
        public BudgetCalendar()
        {
            ...
            ShowToday = true;
            Style.BorderColor = Color.FromArgb( 15, 15, 15 );
            Style.Cell.BlackoutDatesForeColor = Color.FromArgb( 15, 15, 15 );
            ShowFooter = false;

            // Basic Cell Properties
            Style.Cell.CellFont = new Font( "Roboto", 9 );
            Style.Cell.CellBackColor = Color.FromArgb( 15, 15, 15 );
            ...
            Style.Cell.TrailingCellBackColor = Color.FromArgb( 15, 15, 15 );
            Style.Cell.TrailingCellForeColor = Color.FromArgb( 15, 15, 15 );
            ...
            // Header Properties
            Style.Header.BackColor = Color.FromArgb( 15, 15, 15 );
            Style.Header.ForeColor = Color.SteelBlue;
            Style.Header.Font = new Font( "Roboto", 14, FontStyle.Bold );
            Style.Header.DayNamesBackColor = Color.FromArgb( 15, 15, 15 );
            ...
            Style.Header.NavigationButtonDisabledForeColor = Color.FromArgb( 15, 15, 15 );
